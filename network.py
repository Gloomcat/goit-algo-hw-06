...
friendships = [("Alice", "Bob"), ("Alice", "Charlie"), ("Alice", "Fiona"), ("Alice", "George"),
               ("Bob", "Diana"), ("Bob", "Hannah"), ("Charlie",
                                                     "Ian"), ("Diana", "Judy"),
               ("Fiona", "George"), ("Fiona", "Hannah"), ("George", "Ian"), ("Hannah", "Judy"), ("Judy", "Alice")]
...
edge_widths = [weight_mapping[data['weight']]
               for _, _, data in G.edges(data=True)]
...
if __name__ == "__main__":
    ...
    nx.draw_networkx(G, pos, with_labels=True, node_color='lightblue', edge_color=edge_colors,
                     width=edge_widths, node_size=2500, font_size=12, font_weight='bold')
